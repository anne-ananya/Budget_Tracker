                ...
                <Card>
                    <CardHeader>
                        <CardTitle className='flex items-center justify-between gap-2'>
                            <div className="flex items-center gap-2">
                                {type === "expense" ? (
                                    <TrendingDown className='h-12 w-12 items-center rounded-lg  bg-red-400/10 text-red-500' />
                                ) : (
                    ...
                    {!dataAvailable && (
                        <div className="flex h-40 w-full flex-col items-center justify-center">
                            <p>
                                No{" "}
                                <span className={cn("m-1", type === "income" ?
                    ...
                    {
                        dataAvailable && (
                            <div className="grid grid-flow-row p-2 gap-2 sm:grid-flow-row 
